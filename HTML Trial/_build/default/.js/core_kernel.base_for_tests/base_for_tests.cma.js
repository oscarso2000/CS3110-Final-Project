   ...
   {"use strict";
    ...
    function Test_gen(_bS_,_bR_)
     {function init(len,create,set,f)
       {var t=caml_call1(create,len),_cL_=caml_call2(Base[166],len,1),_cK_=0;
        if(! (_cL_ < 0))
         {var i=_cK_;
          for(;;)
      ...
      function _bT_(param)
       {var elt1=caml_call1(_bS_[1][2],1),elt2=caml_call1(_bS_[1][2],0);
        ...
        function src_bit(i)
         {var _cJ_=caml_call2(Base[177],i,1);
          return caml_call2(Base[187],_cJ_,0)?elt1:elt2}
        function dst_bit(i)
         {var _cI_=caml_call2(Base[177],i,1);
          return caml_call2(Base[187],_cI_,0)?elt2:elt1}
        var src_length=0;
        a:
        for(;;)
         {var dst_length=0;
               ...
               {var _bX_=0;
                if(! (dst_length < 0))
                 {var dst_pos=_bX_;
                  for(;;)
                   {var
                     _b0_=caml_call2(Base[166],dst_length,dst_pos),
                     _b1_=caml_call2(Base[166],src_length,src_pos),
                     _b2_=caml_call2(Base[195],_b1_,_b0_),
                     _bZ_=0;
                    if(! (_b2_ < 0))
                     {var src_len=_bZ_;
                      for(;;)
                       {try
                         {var
                           check=
                            function(length,get,name,sequence,expect)
                             {var
                               ...
                               _cB_=caml_call2(Base[166],_cA_,1),
                               _cz_=0;
                              if(! (_cB_ < 0))
                               {var i=_cz_;
                                for(;;)
                                 {var
                                  ...
                                  if(1 - caml_call2(_bS_[1][1],_cD_,_cC_))
                                   {var
                                     _cE_=[0,[1,[0,_g_,[0,caml_call1(Base[115],i),0]]],0],
                                     _cF_=[0,[1,[0,_h_,[0,caml_call1(Base[153],name),0]]],_cE_],
                                     _cG_=
                                      [1,[0,caml_call1(Sexplib0_Sexp_conv[7],cst_bug$0),_cF_]];
                                    caml_call1(Base[207],_cG_)}
                                  var _cH_=i + 1 | 0;
                          ...
                          check_dst
                           (cst_blit_dst,
                            ...
                            function(src_pos,dst_pos,src_len)
                              {return function(i)
                                {var _ch_=caml_call2(Base[189],i,dst_pos);
                                 if(_ch_)
                                  var
                                   _ci_=caml_call2(Base[165],dst_pos,src_len),
                                   _cj_=caml_call2(Base[184],i,_ci_);
                                 else
                                  var _cj_=_ch_;
                                 if(_cj_)
                                  {var _ck_=caml_call2(Base[165],src_pos,i);
                                   return src_bit(caml_call2(Base[166],_ck_,dst_pos))}
                                 return dst_bit(i)}}
                          ...
                          if(typeof _cf_ !== "number")
                           {var
                             src_to_dst=_cf_[2],
                             _cg_=caml_call2(Base[165],dst_pos,src_len);
                            if(caml_call2(Base[185],_cg_,src_length))
                          ...
                          check_dst
                           (cst_sub_dst,
                            ...
                            function(src_pos)
                              {return function(i)
                                {return src_bit(caml_call2(Base[165],src_pos,i))}}
                             (src_pos))}
                        catch(exn$0)
                         {exn$0 = caml_wrap_exception(exn$0);
                          var
                           _b4_=[0,[1,[0,_b_,[0,caml_call1(Base[115],dst_pos),0]]],0],
                           _b5_=
                            [0,[1,[0,_c_,[0,caml_call1(Base[115],dst_length),0]]],_b4_],
                           _b6_=
                            [0,[1,[0,_d_,[0,caml_call1(Base[115],src_pos),0]]],_b5_],
                           _b7_=
                            [0,[1,[0,_e_,[0,caml_call1(Base[115],src_length),0]]],_b6_],
                           _b8_=[0,[1,[0,_f_,[0,caml_call1(Base[103],exn$0),0]]],_b7_],
                           _b9_=[1,[0,caml_call1(Sexplib0_Sexp_conv[7],cst_bug),_b8_]];
                          caml_call1(Base[207],_b9_);
                          var exn=exn$0}
       ...
       {var ___=_Y_[3][1],_aa_=_Y_[3][2],_ab_=_Y_[3][3],_$_=_Y_[3][1];
        ...
        function create_test_case(param)
         {var
           num_b=param[2],
           num_s=param[1],
           _bp_=caml_call2(Base[165],num_s,num_b),
           arr=caml_call2(Base_Array[25],_bp_,_ab_),
           _br_=caml_call2(Base[166],num_s,1),
           _bq_=0;
          if(! (_br_ < 0))
           {var i=_bq_;
            for(;;)
             {runtime.caml_check_bound(arr,i)[1 + i] = _aa_;
              var _bs_=i + 1 | 0;
        ...
        function create_deterministic_test(param)
         {function _bo_(i){return caml_call2(Base[188],i,50000)?_ab_:_aa_}
          return caml_call2(Base_Array[26],100000,_bo_)}
        function _aH_(param)
              ...
              for(;;)
               {var
                 _bd_=
                  function(num_s)
                    {return function(i)
                      {return caml_call2(Base[184],i,num_s)?_aa_:_ab_}}
                   (num_s),
                ...
                if(! (length < -1))
                 {var pos=_be_;
                  for(;;)
                   {var _bh_=caml_call2(Base[165],length,1),_bg_=-1;
                    if(! (_bh_ < -1))
                     {var len=_bg_;
                      for(;;)
                       {var
                        ...
                        if(0 === should_raise)
                         if(0 === result[0])
                          {var
                            result$0=result[1],
                            searched=caml_call2(Base[166],num_s,1);
                           if(caml_call2(Base[184],searched,pos))
                            var correct_result=0;
                           else
                            if(caml_equal(len,0))
                             var correct_result=0;
                            else
                             {var _bm_=caml_call2(Base[165],pos,len);
                              if(caml_call2(Base[189],searched,_bm_))
                               var
                                _bn_=caml_call2(Base[165],pos,len),
                                correct_result=[0,caml_call2(Base[166],_bn_,1)];
                              else
                               var correct_result=[0,searched]}
                           if(1 - caml_equal(correct_result,result$0))
                            caml_call1(Base[205],cst_Wrong_result)}
                         else
                          caml_call1
                           (Base[205],cst_expected_it_to_not_raise_but_it_raised);
                        else
                         if(0 === result[0])
                          caml_call1(Base[205],cst_expected_it_to_raise_but_it_didn_t);
                        var _bl_=len + 1 | 0;
