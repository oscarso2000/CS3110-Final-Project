(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _c_=[0,caml_new_string("_none_"),0,-1];
    function _a_(param)
     {if(param[1] === E)
       {var
         v1=param[3],
    ...
    function fail_in_sexp_style(message,pos,here,tag,body)
     {if(message)
       var
        s=message[1],
        _m_=caml_call2(Base[202],cst,tag),
        message$0=caml_call2(Base[202],s,_m_);
      else
       var message$0=tag;
      var
       _n_=
         ...
         ?[0,
           [1,
            [0,
             ...
             [0,
              caml_call1
               (caml_call1(Base[132],Base_Source_code_position[3]),here),
              0]]],
           0]
         :0,
       _o_=caml_call2(Base[164],[0,[1,[0,_e_,[0,[0,pos],0]]],0],_n_),
       sexp=[1,caml_call2(Base[164],body,_o_)];
    ...
    function test_result_or_eq(sexpifier,comparator,equal,expect$0,got$0)
     {if(equal)
       ...
       var
        ...
        pass=caml_call2(Base[187],_k_,0);
