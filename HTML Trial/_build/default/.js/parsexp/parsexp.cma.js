(function(joo_global_object)
   {"use strict";
    ...
    var
     _h_=[0,caml_new_string("src/positions.ml"),398,12],
     _g_=[0,caml_new_string("src/positions.ml"),377,12],
     _f_=[0,caml_new_string("src/positions.ml"),200,12],
     ...
     _L_=[0,caml_new_string("src/parser_automaton_internal.ml"),565,26],
     _M_=[0,caml_new_string("src/parser_automaton_internal.ml"),593,4],
     _S_=[0,1],
     _R_=[0,-1],
     _Q_=[0,-1],
     _P_=[0,1],
     _O_=[0,0],
     _N_=[0,1],
     _K_=[0,caml_new_string("src/parser_automaton_internal.ml"),523,6],
     _I_=
      [0,caml_new_string("parser_automaton_internal.ml.Public.Parse_error")],
     _J_=[0,caml_new_string("src/parser_automaton_internal.ml"),219,15],
     ...
     _ad_=[0,caml_new_string("src/parsexp.ml"),453,13],
     _ac_=[0,caml_new_string("src/parsexp.ml"),333,13],
     _aa_=[0,caml_new_string("parsexp.ml.Of_sexp_error")],
     _ab_=[0,caml_new_string("src/parsexp.ml"),154,13],
    ...
    function memory_footprint_in_bytes(param)
     {var
       _br_=caml_obj_tag(param),
       t=
        250 === _br_
         ?param[1]
         :246 === _br_?caml_call1(CamlinternalLazy[2],param):param,
       _bs_=Stdlib_sys[10];
      if(32 === _bs_)
       var word_bytes=4;
      else
       {if(64 !== _bs_)throw [0,Assert_failure,_f_];var word_bytes=8}
      var
    ...
    function create$0(param)
     {var
       _bn_=caml_obj_tag(param),
       p=
        250 === _bn_
         ?param[1]
         :246 === _bn_?caml_call1(CamlinternalLazy[2],param):param,
       _bo_=p[1];
      if(_bo_)
       {var chunks=_bo_[2],chunk=_bo_[1];
        return [0,
                chunk,
                chunks,
                p[2],
    ...
    function next_instruction_bits(t,num_bits)
     {if(t[10] < num_bits)
       {if(t[3] < t[5])no_more(0);
        if(t[5] === 62)
         {var _bm_=t[2];
          if(! _bm_)throw [0,Assert_failure,_h_];
          var chunks=_bm_[2],chunk=_bm_[1];
          t[5] = 0;
          t[3] = t[3] - 62 | 0;
          t[1] = chunk;
          t[2] = chunks}
    ...
    function find(t,a,b)
     {var _bh_=a < 0?1:0,_bi_=_bh_ || (b <= a?1:0);
      if(_bi_)caml_call1(Stdlib[1],cst_Parsexp_Positions_find);
      var iter=caml_call1(Iterator[1],t);
      try
       {var
         start_pos=caml_call2(Iterator[3],iter,a),
         last_pos=caml_call2(Iterator[3],iter,(b - a | 0) - 1 | 0),
         _bj_=make_range_incl(start_pos,last_pos);
        return _bj_}
      catch(_bk_)
    ...
    function sub_sexp_count(sexp)
     {if(0 === sexp[0])return 1;
      var l=sexp[1],_bf_=1;
      function _bg_(acc,x){return acc + sub_sexp_count(x) | 0}
      return caml_call3(Stdlib_listLabels[21],_bg_,_bf_,l)}
    var
     Found=
    ...
    function loop_list(sub,index,sexps)
     {function _bc_(_bd_,_be_){return loop(sub,_bd_,_be_)}
      return caml_call3(Stdlib_listLabels[21],_bc_,index,sexps)}
    ...
    function sexp_of_stack(param)
     {if(typeof param !== "number" && 1 === param[0])
      ...
      return caml_call1(Stdlib[2],cst_Parser_automaton_sexp_of_stack)}
     ...
     {var acc=0,param=stack;
      for(;;)
       if(typeof param === "number")
        ...
        {if(0 === param[0])
          return caml_call1(Stdlib[2],cst_Parser_automaton_sexps_of_stack);
         var
          param$0=param[2],
          sexp=param[1],
          acc$0=[0,sexp,acc],
       ...
       if(typeof stack === "number")
        ...
        {if(0 === stack[0])
          {var
            ...
            stack=stack$0;
           continue}
         return caml_call1(Stdlib[2],cst_Parser_automaton_sexps_cst_of_stack)}}
      ...
      switch(reason)
       {case 0:var message=cst_unterminated_hexadecimal_escape_sequence;break;
        ...
        default:
         var
          message=
           caml_call1(Stdlib[2],cst_Parsexp_Parser_automaton_parser_is_dead)}
      if(6 === reason)
       var switch$0=0;
      else
       if(0 === at_eof)
    ...
    function feed_eoi(state,stack)
     {var
       ...
       stack$0=
        caml_call2
         (caml_check_bound(transitions_eoi,_ay_)[1 + _ay_],state,stack);
    ...
    function old_parser_cont_state(state)
     {var match=context(state);
      ...
      var
       ...
       match$0=caml_check_bound(old_parser_approx_cont_states,_ax_)[1 + _ax_],
    ...
    function feed_substring(state,str,pos,len,stack)
     {var str_len=caml_ml_string_length(str),_au_=pos < 0?1:0;
      ...
      if(_av_)caml_call1(Stdlib[1],cst_Parsexp_feed_substring);
    ...
    function feed_subbytes(state,str,pos,len,stack)
     {var str_len=caml_ml_bytes_length(str),_ar_=pos < 0?1:0;
      ...
      if(_as_)caml_call1(Stdlib[1],cst_Parsexp_feed_subbytes);
    ...
    function report(ppf,filename,t)
     {var pos=caml_call1(position$2,t),msg=caml_call1(message$1,t);
      return caml_call6(Stdlib_format[123],ppf,_U_,filename,pos[1],pos[2],msg)}
    ...
    function report$0(ppf,filename,t)
     {var _ap_=t[3];
      ...
      return caml_call7
              (Stdlib_format[123],ppf,_Y_,filename,line,start,stop,_aq_)}
    ...
    var
     Conv_single=
      Make_conv([0,apply_f,find$0],Single,Single_just_positions);
    function apply_f$0(x,f)
     {var _ae_=caml_call2(Stdlib_list[19],f,x);
      return caml_call1(Stdlib_list[9],_ae_)}
    var Conv_many=Make_conv([0,apply_f$0,find$1],Many,Many_just_positions);
    function apply_f$1(x,f){return caml_call1(f,x)}
    var
     Conv_many_at_once=
      Make_conv([0,apply_f$1,find$1],Many,Many_just_positions),
     Private=[0],
     Parsexp$0=
      [0,
